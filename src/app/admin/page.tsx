...
export default function AdminPage() {
  ...
  if (!user) {
    // Should be redirected by useEffect or layout, but as a fallback:
    return <div className="text-center py-10"><p className="text-xl font-body text-muted-foreground">Redirecting to login...</p></div>;
  }

  if (user.email !== ADMIN_EMAIL) {
    // This case should ideally be handled by the layout, but good to have a fallback.
    // The AdminLayout now has its own Access Denied display.
    return (
